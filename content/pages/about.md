...
updated: '2024-05-29T17:45:34+08:00'
excerpt: >-
  本文作者是一位热爱计算机、游戏、摄影和旅行的BYR，梦想成为数字游民并探索太空。技术栈涵盖Web前后端、游戏客户端，正在学习Golang和C++。作者认为写博客是一种记录生活、学习经历和分享个人成果的方式，尤其适合展示摄影作品和编程经验。博客采用Next.js、Prisma和SQLite等技术栈，实现了丰富的功能和动效，如相册展示、文章摘要生成和瀑布流布局。作者强调博客的自由表达和数据所有权，通过Markdown记录文章，实现了与各类笔记软件的无缝迁移。
---
> 大风起↘↗兮云——飞——扬—— 
> 安得猛↘↗士↘兮走——四——方—— 
> 博客，必须要写！不写不行！
