...
const NeonGradientCard: React.FC<NeonGradientCardProps> = ({
  ...
  return (
    <div
      ...
      className={cn("relative z-10 h-full w-full rounded-[var(--border-radius)] transform-gpu", className)}
      {...props}
    >
      <div
        className={cn(
          "transform-gpu relative h-full min-h-[inherit] w-full rounded-[var(--card-content-radius)] bg-gray-100 p-6",
